<%-- 
    Document   : thermometer
    Created on : 20 Aug, 2014, 6:57:45 PM
    Author     : yash
--%>
...
%>              <li><a href="signin.jsp"> Sign In | </a></li>
        ...
        Statement st=con.createStatement(); 
         ...
         %>
                ...
                <img src="thermometer.jpg"  width="300" height="300" align="center"><br>
                ...
                <% 
                       ...
                       {
        %>  
                <a href="cart.jsp?t=Thermometer"><input type="submit"  value="Add to Cart"></a>
