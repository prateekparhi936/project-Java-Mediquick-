<%-- 
    Document   : system7
    Created on : Aug 5, 2014, 10:40:00 PM
...
%>              <li><a href="signin.jsp"> Sign In | </a></li>
        ...
        Statement st=con.createStatement(); 
         ResultSet rs;
         String s1="",s2="",s4="",s5="",s="System 7 Heavy Duty Power Tools";
         int s3=0;
         ...
         %>
         <img src="system7img.jpg"  width="300" height="300" align="center"><br>
...
<a href="cart.jsp?t=System 7 Heavy Duty Power Tools" ><input type="submit"  value="Add to Cart"></a>
<%
        }
       else{
%>              
