<%-- 
    Document   : morganlens
    Created on : Aug 17, 2014, 10:59:02 AM
...
%>              <li><a href="signin.jsp"> Sign In | </a></li>
        ...
        Statement st=con.createStatement(); 
         ResultSet rs;
         String s1="",s2="",s4="",s5="",s="Morgan Lens";
         int s3=0;
         ...
         <img src="MorganLensPhotos.jpg"  width="300" height="300" align="center"><br>
            ...
            <% 
                       ...
                       {
        %>     
<a href="cart.jsp?t=Morgan Lens" ><input type="submit"  value="Add to Cart"></a>      
                 <%
        }
       else{
%>              
