<%-- 
    Document   : bpmonitor
    Created on : 5 Aug, 2014, 10:16:59 PM
    Author     : yash
--%>
...
%>              <li><a href="signin.jsp"> Sign In | </a></li>
        ...
        Statement st=con.createStatement(); 
         ...
         %>
                ...
                <img src="bpmonitor.jpg"  width="300" height="300" align="center"><br>
                ...
                <% 
                       ...
                       {
        %>  
                  <a href="cart.jsp?t=B.P.Monitor"><input type="submit"  value="Add to Cart"></a>
         <%
        }
       else{
%>              
