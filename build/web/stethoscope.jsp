<%-- 
    Document   : stethoscope
    Created on : 5 Aug, 2014, 10:32:00 PM
    Author     : yash
--%>
...
%>              <li><a href="signin.jsp"> Sign In | </a></li>
        ...
        Statement st=con.createStatement(); 
         ...
         %>
                ...
                <img src="Stethoscope.jpg"  width="300" height="300" align="center"><br>
            ...
            <b>Name :</b> <% out.print(s1); %><br>
                ...
                <b>Features :</b><br> <% out.print(s4); %><br>
                 <% 
                       ...
                       {
        %>  
                <a href="cart.jsp?t=Stethoscope" ><input type="submit"  value="Add to Cart"></a>
            <%
        }
       else{
%>              
