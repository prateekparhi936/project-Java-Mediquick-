<%-- 
    Document   : kit
    Created on : Sep 10, 2014, 2:13:25 PM
...
%>              <li><a href="signin.jsp"> Sign In | </a></li>
        ...
        Statement st=con.createStatement(); 
         ResultSet rs;
         String s1="",s2="",s4="",s="First Aid Kit";
         int s3=0;
         ...
         %>
                ...
                <img src="kit.jpg"  width="300" height="300" align="center"><br>
                ...
                <% 
                       ...
                       {
        %>  
                <a href="cart.jsp?t=First Aid Kit"><input type="submit"  value="Add to Cart"></a>
