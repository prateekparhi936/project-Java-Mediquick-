<%-- 
    Document   : hammer
    Created on : 20 Aug, 2014, 7:01:57 PM
    Author     : yash
--%>
...
%>              <li><a href="signin.jsp"> Sign In | </a></li>
        ...
        Statement st=con.createStatement(); 
         ResultSet rs;
         String s1="",s2="",s4="",s="Medical Hammer";
         int s3=0;
         ...
         %>
                ...
                <img src="hammer.jpg"  width="300" height="300" align="center"><br>
                ...
                <% 
                       ...
                       {
        %>  
                  <a href="cart.jsp?t=Medical Hammer"><input type="submit"  value="Add to Cart"></a>
          <%
        }
       else{
%>              
