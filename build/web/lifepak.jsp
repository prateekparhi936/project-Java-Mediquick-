<%-- 
    Document   : lifepak
    Created on : Aug 17, 2014, 11:13:10 AM
...
<html>
    <head>
        ...
        <link href="traumaproduct.css" rel="stylesheet" type="text/css">
    </head>
    <body>
         <div id=wrapper>
            <header>
...
%>              <li><a href="signin.jsp"> Sign In | </a></li>
        ...
        Statement st=con.createStatement(); 
         ResultSet rs;
         String s1="",s2="",s4="",s5="",s="LIFEPAK 15 monitor/defibrillator";
         int s3=0;
         ...
         <img src="lifepack.png"  width="300" height="300" align="center"><br>
...
<a href="cart.jsp?t=LIFEPAK 15 monitor/defibrillator" ><input type="submit"  value="Add to Cart"></a>      
