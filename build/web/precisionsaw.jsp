<%-- 
    Document   : precisionsaw
    Created on : Aug 6, 2014, 9:31:06 AM
...
%>              <li><a href="signin.jsp"> Sign In | </a></li>
        ...
        Statement st=con.createStatement(); 
         ResultSet rs;
         String s1="",s2="",s4="",s5="",s="Precision Saw";
         int s3=0;
         ...
         %>
         <img src="precisionsaw.jpg"  width="300" height="300" align="center"><br>
...
<a href="cart.jsp?t=Precision Saw" ><input type="submit"  value="Add to Cart"></a>  
