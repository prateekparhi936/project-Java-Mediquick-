<%-- 
    Document   : cordless
    Created on : Aug 6, 2014, 9:43:24 AM
...
%>              <li><a href="signin.jsp"> Sign In | </a></li>
        ...
        Statement st=con.createStatement(); 
         ResultSet rs;
         String s1="",s2="",s4="",s5="",s="Cordless Driver III";
         int s3=0;
         ...
         %>
                <img src="cordless.jpg"  width="300" height="300" align="center"><br>
   ...
   <% 
                       ...
                       {
        %>      
<a href="cart.jsp?t=Cordless Driver III"><input type="submit"  value="Add to Cart"></a>
<%
        }
       else{
%>              
